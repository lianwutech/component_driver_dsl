var ARGUMENT_NAMES, Action, ComponentDriverDSL, RawDataProcessor, STRIP_COMMENTS, driver, getParamNames, typeIsArray,
...
Action = (function() {
  ...
  Action.prototype.validate = function() {
    var all_errors, name, retval, _i, _len, _ref;
...
RawDataProcessor = (function() {
  ...
  RawDataProcessor.prototype.validate = function() {
    ...
    if (!this.will_return_data && !this.will_return_state) {
      this.errors.push("data_processor should data() or state(), or both");
    } else {
