...
RawDataProcessor = (function() {
  ...
  RawDataProcessor.prototype.return_data = function(data_format) {
    this.data_format = data_format;
    this.will_return_data = true;
    return this;
  };

  RawDataProcessor.prototype.return_state = function() {
    this.will_return_state = true;
    return this;
  };

  RawDataProcessor.prototype.getResult = function() {
      ...
      return function(item) {
        ...
        switch (item.type) {
          case "number":
            ...
            } else if (typeof item.decimals !== 'number' || item.decimals % 1 !== 0 || !((0 <= (_ref = item.decimals) && _ref <= 9))) {
...
ComponentDriverDSL = (function() {
  ...
  ComponentDriverDSL.prototype.getResult = function() {
    ...
    for (name in _ref1) {
      ...
      if (action.errors.length > 0) {
        ...
        valid_actions[name] = this.actions[name];
      }
    }
    ...
    if (this.raw_data_processor == null) {
      ...
      processor = this.raw_data_processor.getResult();
